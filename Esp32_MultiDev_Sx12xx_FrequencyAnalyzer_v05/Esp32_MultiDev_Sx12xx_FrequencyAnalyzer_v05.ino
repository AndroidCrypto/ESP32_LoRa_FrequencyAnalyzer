...
/*
Version Management
11.02.2025 V05 Additional LoRa board: LilyGo T3S3 SX1262 board
...
const String PROGRAM_VERSION = "LoRa Freqncy Analyzer V05";
...
void setup() {
  ...
  Serial.println(F("ESP32 MD LoRa Frequency Analyzer V05"));
...
void drawFrame() {
  ...
  tft.setCursor(0, 0);
  tft.print("FreqAzr05 " + (String)(currentBaseFrequency / 1000) + "KHz " + (String)channelCounter + "|" + (String)completeRounds);
  tft.setCursor(0, 9);
  tft.print("5");
  tft.setCursor(0, 18);
  tft.print("4");
  ...
  display.drawString(0, 0, "FreqAzr054 " + (String)(currentBaseFrequency / 1000) + "KHz " + (String)channelCounter + "|" + (String)completeRounds);
