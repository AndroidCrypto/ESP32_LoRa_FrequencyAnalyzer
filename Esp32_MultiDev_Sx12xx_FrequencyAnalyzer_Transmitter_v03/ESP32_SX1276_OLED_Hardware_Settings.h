...
#define MISO 19     // MISO 
#define MOSI 23     // MOSI
#define NRESET 17   // reset pin on LoRa device
#define RFBUSY -1   // busy line, not available
...
// ------------------------------------------------------------------
// Rotary Encoder
#define IS_ROTARY_ENCODER
#define ROTARY_ENCODER_SW_PIN 36
#define ROTARY_ENCODER_DT_PIN 37
#define ROTARY_ENCODER_CLK_PIN 38
