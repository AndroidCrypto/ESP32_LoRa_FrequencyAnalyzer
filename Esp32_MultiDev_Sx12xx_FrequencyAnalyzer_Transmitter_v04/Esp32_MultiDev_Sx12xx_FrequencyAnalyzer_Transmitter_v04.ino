...
/*
Version Management
11.02.2025 V04 Additional LoRa board: LilyGo T3S3 SX1262 board
...
const String PROGRAM_VERSION = "Freq Analyzer Transmit V04";
...
void setup() {
  ...
  Serial.println(F("ESP32 MD LoRa Frequency Analyzer Transmitter V04"));
